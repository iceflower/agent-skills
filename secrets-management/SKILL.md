...
> See [references/kubernetes-patterns.md](references/kubernetes-patterns.md) for Sealed Secrets and CSI Secret Store Driver examples.
...
> See [references/kubernetes-patterns.md](references/kubernetes-patterns.md) for K8s environment variable and file mount configuration examples.
